...
| 组件 | 测试用例数 | 语句覆盖率 | 分支覆盖率 | 函数覆盖率 | 状态 |
|------|------------|------------|------------|------------|------|
| **Button** | 30 | 66.66% | 76.66% | 100% | ✅ 通过 |
| **ChatInterface** | 89 | 95.55% | 88.88% | 100% | ✅ 通过 |
| **Input** | 29 | 100% | 100% | 100% | ✅ 通过 |
| **AIMessage** | 33 | 84.88% | 75.43% | 78.57% | ✅ 通过 |
| **AILoading** | 242 | 91.07% | 96.87% | 80.95% | ✅ 通过 |
| **AIPromptInput** | 20 | 30.35% | 39.58% | 21.73% | ✅ 通过 |
